          ...
          <div className="flex flex-col lg:flex-row gap-6 justify-center">
            ...
            <div className="w-full max-w-[580px]">
              <div className="mb-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 rounded-xl bg-white p-5 shadow-sm border border-slate-200/60">
                <div>
                  <h1 className="text-xl font-bold tracking-tight text-slate-900">Your Shared Notes</h1>
                  <p className="text-slate-500 text-[13px] mt-0.5 font-medium">Manage and view all the study resources you've shared.</p>
                </div>
                <button 
              ...
              <div className="space-y-3.5">
                {isLoading ? (
                  ...
                  <div className="rounded-xl border border-rose-200 bg-rose-50 p-8 text-center shadow-sm">
                    <p className="font-bold text-rose-700 text-sm">Failed to load your notes.</p>
                  </div>
                ) : notes.length === 0 ? (
                  <div className="rounded-xl border border-dashed border-slate-300 bg-white p-12 text-center shadow-sm">
                    ...
                    <p className="mt-1 text-slate-500 font-medium text-sm">Start contributing by sharing your helpful notes and links!</p>
                    <button 
                      onClick={() => setIsModalOpen(true)}
