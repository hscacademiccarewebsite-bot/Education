  ...
  return (
    <div className="container-page py-10" role="status" aria-live="polite">
      <div className="mx-auto max-w-4xl">
        {/* Shimmering Header */}
        <div className="relative mb-8 h-48 w-full overflow-hidden rounded-3xl bg-slate-200">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {[1, 2, 3].map((i) => (
            <div key={i} className="relative h-64 overflow-hidden rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-100">
